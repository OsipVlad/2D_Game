...
public class MainHeroPhysicsWalker
{
    ...
    public void FixedUpdate()
    {
        ...
        if (_contactsPoller.IsGrounded && doJump && _characterView.Rigidbody.velocity.y <= _characterView.FlyThresh)
        {
        ...
        {
            _spriteAnimator.StartAnimation(_characterView.SpriteRenderer, 
                isGoSideWay ? Track.walk : Track.idle, true, _characterView.AnimationSpeed);
        }
